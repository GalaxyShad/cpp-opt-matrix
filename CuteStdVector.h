#ifndef CPP_OPT_MATRIX_CUTESTDVECTOR_H
#define CPP_OPT_MATRIX_CUTESTDVECTOR_H
...
template<typename T>
class CuteStdVector : public ICuteVector<T> {
private:
    std::vector<T> map_;
    size_t size_;

public:
    explicit CuteStdVector(size_t size) : size_(size), map_(size) {}
...
#endif//CPP_OPT_MATRIX_CUTESTDVECTOR_H
